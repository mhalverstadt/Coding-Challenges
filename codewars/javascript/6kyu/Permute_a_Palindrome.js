...
function permuteAPalindrome (input) { 
  ...
  return Object.values(charMap).filter(n => n % 2 !== 0).length <= 1
}


console.log(permuteAPalindrome('eeeaaeae'))
console.log(permuteAPalindrome('eeeee'))
console.log(permuteAPalindrome('eeaaeee'))